...
const Comment = ({ score, user, id, content, createdAt, replies }) => {
    ...
    const repliesContent =
        replies && replies.length
            ? replies.map((r) => <Replies CommentId={id} key={r.id} {...r} />)
            : null;
    const btnContent =
        user.username === currentUser ? (
            ...
            <button onClick={(e) => setReplyInputState(true)} className='reply'>
                <img src={reply} alt='' />
        ...
        <div className='comment'>
            <div className='comment-body'>
                <div className='comment-relations'>
                    ...
                    <button
                        style={{ background: 'none',border:'none' }}
                        onClick={(e) => dispatchRemoveLikes({ commentId: id })}
                    >
                ...
                <div className='comment-main'>
                    ...
                    <div className='comment-content'>
                        {editState ? (
                            <div className='edit-content' style={{ width: '100%' }}>
                                <textarea
                                    onChange={(e) =>
